...
public class EsUtils {
     ...
     * @param index
     * @param type
     * @param dataMap key 会作为 文档的id，手动传入，自动生成的为uuid
     * @throws IOException
     */
    public void bulkAdd(String index,String type, Map<String, String> dataMap) throws IOException {
